...
{
	std::cout << "Base Constructor has been called" << std::endl;
	return ;
}
...
{
	std::cout << "Base Copy Constructor has been called" << std::endl;
	*this = copy;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap &copy)
{
	...
	std::cout << "Base Copy assignment operator has been called" << std::endl;
	return (*this);
}

ClapTrap::~ClapTrap()
{
	std::cout << "Base Deconstructor has been called" << std::endl;
	return ;
}
